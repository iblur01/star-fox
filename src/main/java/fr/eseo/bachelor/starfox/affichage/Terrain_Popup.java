...
public class Terrain_Popup {
    ...
    private void generation_hotel(){
        ...
        hotel_terrain.add("Depart");
        hotel_terrain.add("Tacos");
        hotel_terrain.add("Caisse Communauté");
        hotel_terrain.add("Mc Do");
        hotel_terrain.add("Problème de CAF");
        hotel_terrain.add("Bar du Tonton Foch");
        hotel_terrain.add("Point Chicken");
        hotel_terrain.add("Chance");
        hotel_terrain.add("Food 49");
        hotel_terrain.add("Mc Donner");
        hotel_terrain.add("Polytech");
        hotel_terrain.add("La Chapelle");
        hotel_terrain.add("La 7ème compagnie");
        hotel_terrain.add("Le Carré");
        hotel_terrain.add("Le Mid");
        hotel_terrain.add("Bar du Maestro");
        hotel_terrain.add("Le Prime");
        hotel_terrain.add("Caisse Communauté");
        hotel_terrain.add("So Sushi");
        hotel_terrain.add("Fresh Burritos");
        hotel_terrain.add("La Cafet");
        hotel_terrain.add("L'Atoll");
        hotel_terrain.add("Chance");
        hotel_terrain.add("Espace Anjou");
        hotel_terrain.add("Grand Maine");
        hotel_terrain.add("Bar du James Joyces");
        hotel_terrain.add("Lac de Maine");
        hotel_terrain.add("Aqua Vita");
        hotel_terrain.add("La 7ème compagnie");
        hotel_terrain.add("Les Sablières");
        hotel_terrain.add("Allez à Polytech");
        hotel_terrain.add("Jardin des Plantes");
        hotel_terrain.add("Jardin du Mail");
        hotel_terrain.add("Caisse Communauté");
        hotel_terrain.add("Terra Botanica");
        hotel_terrain.add("Bar du Delirium");
        hotel_terrain.add("Chance");
        hotel_terrain.add("Le Château d'Angers");
        hotel_terrain.add("Grève du Crous");
        hotel_terrain.add("ESEO");
    ...
    private void generation_hypotheque(){
        ...
        hypotheque_terrain.add("Depart");
        hypotheque_terrain.add("Tacos");
        hypotheque_terrain.add("Caisse Communauté");
        hypotheque_terrain.add("Mc Do");
        hypotheque_terrain.add("Problème de CAF");
        hypotheque_terrain.add("Bar du Tonton Foch");
        hypotheque_terrain.add("Point Chicken");
        hypotheque_terrain.add("Chance");
        hypotheque_terrain.add("Food 49");
        hypotheque_terrain.add("Mc Donner");
        hypotheque_terrain.add("Polytech");
        hypotheque_terrain.add("La Chapelle");
        hypotheque_terrain.add("La 7ème compagnie");
        hypotheque_terrain.add("Le Carré");
        hypotheque_terrain.add("Le Mid");
        hypotheque_terrain.add("Bar du Maestro");
        hypotheque_terrain.add("Le Prime");
        hypotheque_terrain.add("Caisse Communauté");
        hypotheque_terrain.add("So Sushi");
        hypotheque_terrain.add("Fresh Burritos");
        hypotheque_terrain.add("La Cafet");
        hypotheque_terrain.add("L'Atoll");
        hypotheque_terrain.add("Chance");
        hypotheque_terrain.add("Espace Anjou");
        hypotheque_terrain.add("Grand Maine");
        hypotheque_terrain.add("Bar du James Joyces");
        hypotheque_terrain.add("Lac de Maine");
        hypotheque_terrain.add("Aqua Vita");
        hypotheque_terrain.add("La 7ème compagnie");
        hypotheque_terrain.add("Les Sablières");
        hypotheque_terrain.add("Allez à Polytech");
        hypotheque_terrain.add("Jardin des Plantes");
        hypotheque_terrain.add("Jardin du Mail");
        hypotheque_terrain.add("Caisse Communauté");
        hypotheque_terrain.add("Terra Botanica");
        hypotheque_terrain.add("Bar du Delirium");
        hypotheque_terrain.add("Chance");
        hypotheque_terrain.add("Le Château d'Angers");
        hypotheque_terrain.add("Grève du Crous");
        hypotheque_terrain.add("ESEO");
